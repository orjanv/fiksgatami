...
public class About extends Activity {
	...
	protected void onCreate(Bundle icicle) {
		...
		noteView2.setText("Dette er versjon " + versionName + " av FiksGataMi for Android, skrevet av Anna Powell-Smith, oversatt til Norsk av �rjan Hoyd V�llestad. Takk til Paul for testing.");
